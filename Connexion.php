  ...
  <body class="u-body u-xl-mode" data-lang="fr"><header class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-clearfix u-header u-section-row-container" id="sec-0749" style=""><div class="u-section-rows">
    ...
    <section class="u-border-10 u-border-custom-color-2 u-border-no-left u-border-no-right u-clearfix u-custom-color-1 u-section-2" id="sec-27d3">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h3 class="u-text u-text-default u-text-1"><span class="u-file-icon u-icon u-text-white u-icon-1"><img src="images/9358880-46218739.png" alt=""></span>&nbsp;<span style="font-weight: 700;">CONNEXION 
        </h3>
        <div class="u-form u-form-1">

            <form action="Login/connexion_post.php" method="post">            
            <div class="u-form-group u-form-name u-label-top">
              <label for="name-f580" class="u-label u-label-1">Adresse Email</label>
              <input type="text" id="name-f580" name="email" class="u-border-2 u-border-custom-color-2 u-custom-color-6 u-input u-input-rectangle u-text-white u-input-1" required="">
            </div>

            <div class="u-form-email u-form-group u-label-top">
              <label for="email-f580" class="u-label u-label-2">Mot de passe</label>
              <input type="password" id="email-f580" name="password" class="u-border-2 u-border-custom-color-2 u-custom-color-6 u-input u-input-rectangle u-text-white u-input-2" required="">
            </div>

            <div class="u-align-center u-form-group u-form-submit u-label-top">
              <input type="submit" value="submit" class="u-form-control-hidden">
              <a href="#" class="u-border-3 u-border-active-custom-color-4 u-border-custom-color-4 u-border-hover-custom-color-4 u-border-no-left u-border-no-right u-border-no-top u-btn u-btn-round u-btn-submit u-button-style u-custom-color-3 u-hover-custom-color-3 u-radius-7 u-btn-1" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">Connexion</a>
            </div>
