        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Modifier les information du projets</h4>

                    <?php
            require_once '../function.php'; 
            $requeteinfo = $bdd->prepare('SELECT * FROM Info');
            $requeteinfo->execute();
            $reponseinfo = $requeteinfo->fetch(PDO::FETCH_ASSOC);
            ...
            echo'
                    ...
                    <form action="updateinfo_post.php" method="post">
        
                      <div class="form-group">
                        <label for="exampleInputName1">Objectif</label>
                        <input type="text" class="form-control" name="objectif" value="'.$reponseinfo['Objectif'].'">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Crédit</label>
