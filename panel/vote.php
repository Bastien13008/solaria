          ...
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                  ...
                  <div class="card-body">
                    ...
                    <form action="vote_post.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="vote" placeholder="Le montant">
                      </div>                  
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">List des votes</h4>
...
<tr>
  ...
  while ($reponsepay = $stmt->fetch(PDO::FETCH_ASSOC)) {
      echo '
              ...
              if($reponsepay['VoteTimer']== 0) { 
                    echo'
                    <td>
                    <label class="badge badge-success">Disponible</label>
                    </td>';
                  } 
              elseif($reponsepay['VoteTimer'] == 1) { 
                    echo'
                    <td>
                    ...
                    echo'
                    <td>
                    <a href="restartvote.php?id='.$reponsepay['ID'].'">
