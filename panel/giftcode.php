        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Crée un code promo</h4>

                    <form action="giftcode_post.php" method="post">
                      <div class="form-group">
                        <label for="exampleInputName1">L'auteur</label>
                        <input type="text" class="form-control" name="auteur" placeholder="L'auteur">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Le montant</label>
                        <input type="text" class="form-control" name="token" placeholder="Le montant">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Le code promo</label>
                        <input type="text" class="form-control" name="code" placeholder="Le code promo">
                      </div>                    
...
<tr>
  ...
  $stmt = $pdo->prepare('SELECT * FROM GiftCode');
  $stmt->execute();
      ...
      echo '
                <tbody>
                  <tr>
                    ...
                    <td> '.$reponsepay['code'].'</td>
                    ';

              if($reponsepay['Statut']== 0) { 
                    echo'
                    <td>
                    <label class="badge badge-success">Disponible</label>
                    </td>';
                  } 
              elseif($reponsepay['Statut'] == 1) { 
                    echo'
                    <td>
                    ...
                    echo'
                    <td>
                    <a href="deletetoken.php?id='.$reponsepay['ID'].'">
