        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Crée des votes</h4>
                    ...
                    <form action="article_post.php" method="post">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="Title" placeholder="Le pseudo">
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1">Votre Articles</label>
                        <textarea class="form-control" id="exampleTextarea1" name="Descript" rows="6" placeholder="L'article"></textarea>
                      </div>
                      <div class="form-group">
...
function load_messages(){
    $('#update').load("update_article.php");
}
