...
<html style="font-size: 16px;" lang="fr"><head>
  ...
  <body data-home-page="Accueil.html" data-home-page-title="Accueil" class="u-body u-xl-mode" data-lang="fr"><header class="u-border-no-bottom u-border-no-left u-border-no-right u-border-no-top u-clearfix u-header u-section-row-container" id="sec-0749" style=""><div class="u-section-rows">
        <div class="u-custom-color-1 u-section-row u-section-row-1">
        ...
        <div class="u-clearfix u-grey-90 u-section-row u-section-row-2" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">
...
$stmt = $bdd->prepare("SELECT * FROM Article ORDER BY Date DESC"); 
$stmt->execute();
...
while ($row = $stmt->fetch()) {
    echo'
    <div class="u-container-style u-custom-color-black u-expanded-width-sm u-expanded-width-xs u-group u-radius-13 u-shape-round u-group-2">
      <div class="u-container-layout u-container-layout-5">
      <a href="Article.php?id='.$row['ID'].'">
        <img target="_blank" class="u-expanded-width u-image u-image-default u-image-1" src="'.$row['Images'].'" alt="" data-image-width="1280" data-image-height="853">
        </a>
        <h5 class="u-text u-text-default u-text-1">'.$row['Title'].'</h5>
        <h6 class="u-text u-text-default u-text-2">'.$row['date'].'</h6>
      </div>
    </div>
'; 
}
